...
{: .warning } 
> This lab requires a bring-your-own tenant configuration. Depending on your tenant type, you may need to complete additional setup steps before you can deploy a cloud PC pool for the agent.
>
Supported tenant types include:
- M365 Enterprise
- Copilot Individual Demo Tenant
- A custom tenant

{: .important } 
> Computer-use agents in Copilot Studio are a preview technology. The user interface, features, and functionality may change. Your experience may differ from the lab instructions.
> You may not be able to complete every step in the lab.
